...
export const defaultTestMap = new Map([
    ["Primary_HPV",{
        ...
        "probabilities": function (year,params) {
            const defaults = defaultTestParameters.get("HPV");
            ...
            if (year == 0){
                return {
                    ...
                    CIN2: {"HPV_NEGATIVE":1-CIN2.sensitivity,"HPV_POSITIVE":CIN2.sensitivity},
                    CIN3: {"HPV_NEGATIVE":1-CIN3.sensitivity,"HPV_POSITIVE":CIN3.sensitivity},    
                }
            } 
            return {
        ...
        "probabilities": function (year,params) {
            ...
            if (year>0){
                return {
                    ...
                    CIN2: {
                        "HPV_NEGATIVE": 1 - CIN2.sensitivity, "HPV_56_59_66": 0.044192812 * CIN2.sensitivity,
                        "HPV_OTHER": 0.5407587698322 * CIN2.sensitivity, "HPV16": 0.3443049813002 * CIN2.sensitivity,
                        "HPV18": 0.0707434371307 * CIN2.sensitivity
                    },
                    CIN3: {
                        "HPV_NEGATIVE": 1 - CIN3.sensitivity, "HPV_56_59_66": 0.0231557970530 * CIN3.sensitivity,
                        "HPV_OTHER": 0.4118072214929 * CIN3.sensitivity, "HPV16": 0.5020244012067 * CIN3.sensitivity,
                        "HPV18": 0.0630125802475 * CIN3.sensitivity
                    }
                }
            }
            return {
    ...
    ["HPV_COTEST", {
        ...
        probabilities: function (year,params) {
            const hpv = defaultTestParameters.get("HPV");
            const CIN2 = (params && params.CIN2) ? params.CIN2 : defaults.CIN2;
            const CIN3 = (params && params.CIN3) ? params.CIN3 : defaults.CIN3;
            return {
                CIN_LT_2: {
                ...
                CIN2: {
                    "HPV_POSITIVE_NILM": 1-Cytology_sensitivity, "HPV_POSITIVE_ASC_US": Cytology_sensitivity*0.3121406831246,
                    "HPV_POSITIVE_LSIL": Cytology_sensitivity*0.2799586048487, "HPV_POSITIVE_HIGH_GRADE": Cytology_sensitivity*0.4079007120267,
    ...
    ["Dual_Stain_HPV_56_59_66",{
        ...
        "outcomes": ["DS_POSITIVE", "DS_NEGATIVE"],
        "probabilities": function (year) {
            // p={specificity,sensitivity,sensitivity...}
...
export const adjustableTests = {
    scenario1: ["HPV","Cytology","Colposcopy"],
    scenario2: ["HPV","Colposcopy"],
    scenario3: ["HPV","Cytology","Colposcopy"],
    scenario4: ["HPV","Colposcopy"],
    scenario5: ["Colposcopy"],
    scenario6: ["Colposcopy"],
}
